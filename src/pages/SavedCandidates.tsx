// This component displays the list of saved candidates from the local storage. It allows the user to filter and sort the list of saved candidates. 
//The user can also reject a candidate from the list.
...
const SavedCandidates = () => {
 ...
 // Filter candidates based on the filter text entered by the user 
        ...
        <div>
          <div className="filter">
            ...
            <select
              ...
              onChange={(e) =>
                setSortBy(
                  e.target.value as "name" | "location" | "company" | null
                )
              }
            >
